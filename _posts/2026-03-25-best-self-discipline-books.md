...
1. **Read with a pen.** Highlight, underline, write in the margins. Active reading beats passive reading every time.
2. **One book at a time.** Don't stack five books. Read one, apply the lessons, then move to the next.
3. **Implement within 24 hours.** Finish a chapter? Apply one idea before you start the next. Knowledge without action is entertainment.
4. **Re-read the best ones.** The best self-discipline books reveal new layers each time you revisit them. *Meditations* hits different at 25 than it does at 20.
5. **Build a reading habit.** Even 20 minutes a day adds up to roughly 20 books a year. That's the compound effect in action.
